...
public class BrokerServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        case "subscribe": {
          service.subscribe((java.lang.String)json.getValue("url"),
                        HelperUtils.createHandler(msg));
          break;
        }
        case "unsubscribe": {
          service.unsubscribe((java.lang.String)json.getValue("url"),
                        HelperUtils.createHandler(msg));
          break;
        }
        case "subscribeAll": {
          service.subscribeAll(HelperUtils.createHandler(msg));
          break;
        }
        case "unsubscribeAll": {
          service.unsubscribeAll(HelperUtils.createHandler(msg));
          break;
        }
        case "update": {
          service.update(HelperUtils.createHandler(msg));
          break;
        }
